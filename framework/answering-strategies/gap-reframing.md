...
When the recruiter asks about experience/skills you don't have, **gap reframing** is the technique of:
1. Acknowledging the gap honestly
...
**What it is:** A technique for addressing missing experience, skills, or certifications without disqualifying yourself.

**How to apply:** "[Acknowledge gap]. [Pivot to adjacent strength]. [Question back or outcome framing]."

**Example:**
> **Recruiter:** "Do you have Terraform experience?"
>
> **You:** "Not Terraform specifically, but I manage [N] environments end-to-end with [your IaC tool]. Since both are Infrastructure as Code, the thinking is the same. Does the client need Terraform specifically, or IaC experience?"

**Why this works:**
- ✓ Honest about the gap (no sneaking past filters)
- ✓ Shows what you DO have that's related
- ✓ Reframes requirement (tool vs. outcome)
- ✓ Helps recruiter understand if gap actually matters

**When to use:** Whenever recruiter asks about experience, skills, certifications, or domain knowledge you don't have.

**Critical rule:** Never volunteer gaps. Only reframe what they explicitly ask about.

---

## Why This Works

Recruiters are checkbox-matching. But they often don't know whether a checkbox is a **hard requirement** (must-have) or a **nice-to-have** (client will accept alternatives).

Your job is to help them understand:
- What you DO have that's related
- Whether that's sufficient for the client's actual needs

If you can do the job, the specific tool/tech/industry often doesn't matter.
...
### ❌ Denying the Gap
> "Well, I've worked with Angular which is basically the same as React..."

**Why this fails:** You sound like you're trying to sneak past the filter.

### ❌ Apologizing for the Gap
> "I'm sorry, I don't have that. I wish I did..."

**Why this fails:** Apologizing makes the gap sound like a dealbreaker.

### ❌ Over-Explaining Why the Gap Exists
> "I didn't have the opportunity to work with React because my team used Angular, and by the time React became popular..."

**Why this fails:** Recruiter doesn't care why. They care whether you can do the job.

### ❌ Saying "Not Really" or "No"
...
> "[Acknowledge gap]. [Pivot to adjacent strength]. [Question back or outcome framing]."
...
## Gap Reframing by Type

### Type 1: Specific Technology/Tool Gap

**Pattern:** "Not [X] specifically, but I [adjacent tech]. [Outcome you deliver]."
...
### Type 2: Certification Gap

**Pattern:** "Certification [status], but the practical experience the cert validates, [evidence]."
...
**Key:** Status → Practical experience → Question if cert is hard requirement

---

### Type 3: Industry/Domain Gap

**Pattern:** "Not [industry] specifically, but I [transferable domain experience]. [Outcome framing]."
...
### Type 4: Missing "Nice-to-Have" from Job Ad

**Pattern:** Ignore it in your pitch, address it only if asked.
...
### Type 5: Timeline/Recency Gap

**Pattern:** "[Time since last use], but [what you remember / why it's still relevant]."
...
**Recruiter:** "[Question probing a gap in your experience]"

**Your reframe:**
> "[Honest acknowledgement]. [Pivot to constituent skills you DO have]. [Question-back that reframes the requirement]."
...
## Common Mistake: Over-Reframing

### ❌ Reframing a Non-Gap

**Bad:**
> Recruiter: "I see you have [N] years of [language] experience."
> You: "Yes, and while I don't have [other language], [language] and [other language] are very similar..."

**Why this fails:** You just volunteered a negative. They didn't ask about [other language].

**Good:**
> Recruiter: "I see you have [N] years of [language] experience."
> You: "Correct, [N]+ years, with the last [M] years focused on [your primary platform/domain]."

**Rule:** Only reframe gaps they explicitly ask about. Never volunteer a gap.

---

## When Gap Reframing Doesn't Work

### Hard Requirements You Can't Reframe

Some gaps are genuinely disqualifying:
- Job requires German, you don't speak German
- Job requires active security clearance, you don't have it
- Job requires on-site presence 5 days/week, you're in another country

**In these cases:**
> "No, I don't. Is that a hard requirement or is there flexibility?"

Don't try to reframe the un-reframable. Just ask if it's negotiable.

---

## Practice Exercise

For each gap in your profile:
1. What's the gap?
2. What's the adjacent strength?
3. What's the outcome framing or question-back?
