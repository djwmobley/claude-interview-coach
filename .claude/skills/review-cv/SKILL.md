...
2. **Tense correctness:** For any project whose end date is "present" (an ongoing engagement), check that the description uses present tense. For completed projects, check for past tense. Flag mismatches as **MINOR**.
...
|---|----------|----------|-------|----------|
| 1 | CRITICAL | Keyword  | "PostgreSQL" not found in CV | N/A |
